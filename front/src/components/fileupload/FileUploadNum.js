...
const DEFAULT_MAX_FILE_SIZE_IN_BYTES = 5000000000000000000000;
...
const FileUploadNum = ({
  ...
  const { clickedCdos, setDataToProviderClickedCdos } = useContext(NameContext);
  const handleUploadBtnClick = () => {
    fileInputField.current.click();
    setDataToProviderClickedCdos(false);
  };
  ...
  return (
    <>
      ...
      {Object.keys(files).length === 0 || clickedCdos === true ? null : (
        <>
          <FilePreviewContainer>
            <span
              style={{
